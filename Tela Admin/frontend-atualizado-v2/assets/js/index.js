...
async function handleLogin(e) {
    ...
    try {
        // Envia 'usuario' e 'password' para o servidor
        const response = await fetch('https://back-end-logika-barbeiros.vercel.app/login', {
            method: 'POST',
        ...
        if (response.ok) {
            ...
            // O objeto 'user' agora contém 'usuario' em vez de 'email'
